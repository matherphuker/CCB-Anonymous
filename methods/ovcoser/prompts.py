...
CAMO_PROMPTS_FULL = [
    "A photo of a camouflaged {} in a background with {}.",
    "A photo of the {} blending into an environment with {}.",
    "A photo of the {} concealed within the {} setting.",
    "A photo of the {} naturally blending into the background with {}.",
    "A photo of the {} hidden in the surroundings with {}.",
    "A photo of the {} perfectly camouflaged against the backdrop with {}.",
    "A photo of a well-hidden {} in a {} environment.",
    "A photo of a {} that is nearly invisible in the landscape with {}.",
    "A photo of the {} disguised within the {} terrain.",
    "A photo of the {} merging seamlessly into the {} scene."
]

def get_prompt_template_by_name(name):
    if name == "camoprompts":
        template_set = CAMO_PROMPTS
    elif name == "fullcamoprompts":
        template_set = CAMO_PROMPTS_FULL
    elif name == "imagenet":
